...
# ☁️ viewport-relative arena bounds
var arena_left = 0
var arena_right = 0
var arena_top = 0
var arena_bottom = 0
...
func _ready():
	...
	arena_left = 0
	arena_right = screen_size.x

	# ☁️ keep clouds in upper/mid sky
	arena_top = screen_size.y * 0.1
	arena_bottom = screen_size.y * 0.6
...
func spawn_cloud():
	...
	match chosen.name:
		...
		"CloudsBack":
			...
			cloud.target_alpha = randf_range(
				0.15,
				0.35
			)
